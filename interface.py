...
class ModuleInterface:
    def __init__(self, module_controller: ModuleController):
        ...
        self.session = Qobuz(
            settings["app_id"], settings["app_secret"], module_controller.module_error
        )  # TODO: get rid of this module_error thing
        self.session.auth_token = module_controller.temporary_settings_controller.read(
            "token"
        )
    ...
    def get_track_info(
        self, track_id, quality_tier: QualityEnum, codec_options: CodecOptions, data={}
    ):
        track_data = (
    ...
    def get_album_info(self, album_id):
        ...
        return AlbumInfo(
            ...
            quality=self.quality_format.format(**quality_tags)
